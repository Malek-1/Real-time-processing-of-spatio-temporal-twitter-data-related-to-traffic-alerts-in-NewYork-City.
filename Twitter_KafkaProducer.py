...
bearer_token = os.environ.get("AAAAAAAAAAAAAAAAAAAAAP%2BChgEAAAAAT%2FIYAjv2xoJ71IHYRhwpdSSHIvk%3D6Ou8Z7joCoL7PaBYu1bJECpPNu8u47oDPt32QB1o2ibxry6Mgv")
...
def bearer_oauth(r):
    ...
    """
    ch1 = "AAAAAAAAAAAAAAAAAAAAAP%2BChgEAAAAAT%2FIYAjv2xoJ71IHYRhwpdSSHIvk"
    ch2 = "%3D6Ou8Z7joCoL7PaBYu1bJECpPNu8u47oDPt32QB1o2ibxry6Mgv"
    
    r.headers["Authorization"] = f"Bearer {ch1+ch2}"
